...
% Different type of attacks on image
...
hold on;
plot(Sppoints(:,1),Sppoints(:,2),'r+');axis off;
...
hold on;
plot(Tpoints(:,1),Tpoints(:,2),'r+');axis off;
...
hold on;
plot(Jpoints(:,1),Jpoints(:,2),'r+');axis off;

% hausdorff(Opoints,Tpoints)